...
// import 'package:noq/services/authentication.dart';
...
//   var smsOTPSent =
//       (String verId, [int forceCodeResend]) => print("On OTP Sent: " + verId);

//   var authDone = (AuthCredential auth) => {
...
//   };
//   registerOTPHandlers() {
//     widget.auth.onOTPSent = smsOTPSent;
//     //widget.auth.onAuthDone = authDone;
//   }
...
//           userId = await widget.auth.signInWithPhone("+91" + _phone);
