...
class BookingMsgAlert extends StatefulWidget {
  @override
  _BookingMsgAlertState createState() => _BookingMsgAlertState();
}

class _BookingMsgAlertState extends State<BookingMsgAlert> {
  @override
